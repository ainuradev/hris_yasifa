        ...
        <nav class="sidebar-scroll flex-1 overflow-y-auto px-3 py-4">
            ...
            @php
                $adminLinks = [
                    ...
                    ['label'=>'Jadwal Guru',     'route'=>'admin.jadwal.index',      'match'=>'admin.jadwal.*',       'icon'=>'cal'],
                    ['label'=>'Jadwal Kelas',    'route'=>'admin.jadwal-kelas.index','match'=>'admin.jadwal-kelas.*', 'icon'=>'book'],
...
<nav id="bottom-nav"
    ...
    @php
        $bottomLinks = [
            ...
            ['label' => 'Jadwal',   'route' => 'admin.jadwal.index',      'match' => 'admin.jadwal.*'],
        ...
        $bottomIcons = [
            ...
            'admin.jadwal.*'      => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',
